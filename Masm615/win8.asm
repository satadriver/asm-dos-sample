...
HdBufSelector		dq 00cf92400000ffffh	;256M
...
HdFat32BufSeg           =$-NullSelector
HdFat32BufSelector      dq 104f92a00000ffffh

VesaBackingSeg		=$-NullSelector
VesaBackingSelector	dq 20cf92000000ffffh	;256M
...
Tss0Selector            dq 0000890000000067h
Tss1Seg                 =$-NullSelector
Tss1Selector            dq 0000890000000067h
Tss2Seg                 =$-NullSelector
Tss2Selector            dq 0000890000000067h
Tss3Seg                 =$-NullSelector
Tss3Selector            dq 0000890000000067h
...
pop ecx
loop ShowMouseGraph
jmp near ptr PmMouseIntReturn		;jmp is illegal when offset above 128b in masm5.0,why?????
...
mov ax,ParamSeg
mov ds,ax
mov ax,HdFat32BufSeg
mov es,ax
cld
;this method is not effective! how to improve it?????
xor eax,eax
mov ecx,1
mov edi,0
mov bh,0
...
LowerLetterToCapitals proc near
push eax
push ecx
push esi
push edi
...
pop eax
ret
LowerLetterToCapitals endp



ReadFileSubDir proc near
pushad
push ds
push es
mov ax,ParamSeg
...
mov bh,1
int 82h
jmp near ptr ReadFileSubDirRet
...
pop ecx
mov ax,es:[edi+14h]
mov word ptr ds:[FileFirstClu+2],ax
mov ax,es:[edi+1ah]		
mov word ptr ds:[FileFirstClu],ax
mov eax,es:[edi+1ch]
mov ds:[FileSize],eax
...
mov byte ptr ds:[DeskTopBkgrdAlterFlag],1
mov bh,0
int 83h
...
mov al,0bh
out 70h,al
mov al,52h      ;enable periodic and timing int
out 71h,al
ret
SetRltPort endp
